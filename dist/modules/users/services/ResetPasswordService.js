...
var ResetPasswordService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        console.log(token);
                        return [4 /*yield*/, this.userTokenRepository.findByToken(token)];
                    case 1:
                        userToken = _c.sent();
                        if (!userToken) {
                            throw new AppError_1.default('User token does not exists', 401);
                        }
    ...
    ResetPasswordService = __decorate([
        ...
        __param(1, tsyringe_1.inject('UserToken')),
